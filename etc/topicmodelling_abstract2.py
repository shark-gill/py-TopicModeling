...
rawdata = pd.read_csv('/content/rawdata_abstract.csv', encoding='cp949')
...
def clean_stopword(d): # 
    ...
    stop_words.extend(['information', 'geographic', 'geospatial', 'method'])
...
lda_model = LdaModel(corpus, num_topics = 11, id2word=dictionary)
topics = lda_model.print_topics()
topics
